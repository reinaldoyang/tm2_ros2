...
def generate_launch_description():
    ...
    tm_robot_type = 'tm7s_robotiq'
    description_path = 'tm_description'
    xacro_path = 'config/tm7s_robotiq.urdf.xacro'
    moveit_config_path = 'tm7s_robotiq_moveit_config'
    srdf_path = 'config/tm7s_robotiq.srdf'
